    ...
    render() {
        ...
        return (
            <Card className="float-card">
                <div className="main">
                    <div className="method"><img src={require('@images/phone.svg')} alt="" />线上咨询<span className="price">{audioPrice}</span></div>
                    <div className="method"><img src={require('@images/web_camera.svg')} alt="" />线下咨询<span className="price">{videoPrice}</span></div>
