          ...
          return (
            <div className="comment" key={cmt.id}>
              <Comment
                ...
                // avatar={<Avatar src={avatarURL} alt={cmt.authorName}>{cmt.authorName}</Avatar>}
                avatar={<Avatar alt={cmt.authorName}>{cmt.authorName}</Avatar>}
                  ...
                  ? subCmt.map(subCmt => (
                    <div className="comment" key={subCmt.id}>
                      <Comment
                        ...
                        avatar={<Avatar alt={subCmt.authorName}>{subCmt.authorName}</Avatar>}
                        content={
                          <p>
